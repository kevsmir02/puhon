...
const SIDEBAR_WIDTH_STORAGE_KEY = "puhon.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "puhon.sidebar.view";
const SIDEBAR_COLLAPSED_STORAGE_KEY = "puhon.sidebar.collapsed";
